...
/** 候选人转员工 / 确认入职表单（精简版） */
export function useEmployeeEntryFormSchema(): VbenFormSchema[] {
  return [
    {
      fieldName: 'id',
      component: 'Input',
    ...
    },
    {
      ...
      component: 'Select',
      rules: 'required',
      defaultValue: HrmEmployeeStatus.PROBATION,
      componentProps: {
    ...
    },
    {
      ...
      componentProps: {
        options: [
          { label: '在职', value: HrmEmployeeEntryStatus.ACTIVE },
          { label: '待入职', value: HrmEmployeeEntryStatus.PENDING_ENTRY },
        ],
        placeholder: '请选择入职状态',
        allowClear: true,
      },
